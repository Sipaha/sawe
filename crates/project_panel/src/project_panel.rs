...
use ui::{
    ...
    IndentGuideLayout, Indicator, Label, LabelSize, ListItem, ListItemSpacing, ScrollAxes,
...
impl ProjectPanel {
    ...
    fn render_entry(
        ...
        // Keep the focus border visible throughout a click with preview tabs.
        let show_focused_border = is_active && self.contains_focus(window, cx);
                ...
                ListItem::new(id)
                    ...
                    .map(|this| {
                        ...
                        let chevron = chevron.map(|chevron| {
                            let glyph = match diagnostic_mark.zip(decoration_color) {
                            ...
                            h_flex()
                                .id(SharedString::from(format!("chevron-{entry_id:?}")))
                                .flex_none()
                                .cursor_pointer()
