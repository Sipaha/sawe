...
const URL_REGEX: &str = r#"(ipfs:|ipns:|magnet:|mailto:|gemini://|gopher://|https://|http://|news:|file://|git://|ssh:|ftp://|sawe://)[^\u{0000}-\u{001F}\u{007F}-\u{009F}<>"\s{-}\^⟨⟩`']+"#;
...
mod tests {
    ...
    fn test_url_regex() {
        ...
        re_test(
            URL_REGEX,
            "open sawe://channel/the-channel and sawe://settings/theme now",
            vec!["sawe://channel/the-channel", "sawe://settings/theme"],
        );
    }
