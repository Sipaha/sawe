...
pub use lifecycle::{
    cleanup_legacy_runtime_dir, close_solution_socket, is_global_tool, open_solution_socket,
    runtime_dir, set_runtime_dir_for_test, socket_path, solution_scope_for_path,
    solution_socket_for_path, solution_socket_path, start_server,
};
