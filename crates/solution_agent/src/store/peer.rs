        ...
        cx.spawn(async move |this, cx| {
            let (wake, epoch) = this.update(cx, |store, cx| -> Result<_> {
                ...
                let meta = SolutionSessionMetadata {
                    ...
                    desired_model:s.desired_model.clone(),desired_effort:s.desired_effort.clone(),permission_mode:s.permission_mode,title_source:s.title_source,cached_models:s.cached_models.clone(),tab_order:s.tab_order,
                };
