...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Sawe-Dev",
        ReleaseChannel::Nightly => "Sawe-Nightly",
        ReleaseChannel::Preview => "Sawe-Preview",
        ReleaseChannel::Stable => "Sawe-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "ru.sipaha.sawe-dev",
            ReleaseChannel::Nightly => "ru.sipaha.sawe-nightly",
            ReleaseChannel::Preview => "ru.sipaha.sawe-preview",
            ReleaseChannel::Stable => "ru.sipaha.sawe",
        }
    }
