...
use gpui::{
    ...
    Global, InteractiveElement, IntoElement, Modifiers, ModifiersChangedEvent, ParentElement,
...
pub fn open(
    ...
    let repository = solutions::active_member_repository(&project, cx)
            ...
            PickerState::List | PickerState::NewRemote | PickerState::NewBranch => {
                if self.is_select_only() {
                    ...
                    match self.branch_filter {
                        BranchFilter::All | BranchFilter::Remote | BranchFilter::Local => {
                            "Switch branch…"
                        }
                    }
                }
