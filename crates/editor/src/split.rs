...
use gpui::{
    Action, AnyElement, Entity, EventEmitter, Focusable, Font, Pixels, SharedString, Subscription,
    WeakEntity, canvas, prelude::*,
};
...
impl SplittableEditor {
    ...
    pub fn set_diff_hunk_renderer(
        ...
        self.rhs_editor
            .update(cx, |editor, cx| editor.set_diff_hunk_renderer(renderer, cx));
        self.diff_hunk_controls_disabled = false;
    }

    pub fn set_render_diff_hunk_controls(
        &mut self,
        controls: crate::RenderDiffHunkControlsFn,
        cx: &mut Context<Self>,
    ) {
        self.rhs_editor.update(cx, |editor, cx| {
            editor.set_render_diff_hunk_controls(controls, cx)
        });
        self.diff_hunk_controls_disabled = false;
    }
    ...
    pub fn disable_diff_hunk_controls(&mut self, cx: &mut Context<Self>) {
        ...
        self.rhs_editor.update(cx, |editor, cx| {
            editor.set_render_diff_hunk_controls(empty_controls, cx);
        });
