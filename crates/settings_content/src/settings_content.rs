...
fallible_options::flattened_deserialize!(SettingsContent {
    ...
    options: {
        ...
        instrumentation, solutions, solution_agent, run_config,
    },
    defaults: {},
});
...
pub struct GitPanelSettingsContent {
    ...
    /// Legacy Sawe folder-icon preference.
    ...
    /// Legacy Sawe preference for a path-sorted list instead of status sections.
