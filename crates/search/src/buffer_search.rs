...
use editor::{
    ...
    actions::{
        Backtab, FoldAll, GoToHunk, GoToPreviousHunk, Tab, ToggleFoldAll, ToggleSoftWrap, UnfoldAll,
    },
    scroll::Autoscroll,
};
use fs::Fs;
...
use ui::{
    BASE_REM_SIZE_IN_PX, IconButtonShape, Tooltip, prelude::*, render_modifiers,
