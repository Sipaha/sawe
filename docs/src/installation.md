...
Sawe is uninstalled by running the shell command `sawe --uninstall`; see [Uninstall](./uninstall.md) for what it removes and what it leaves behind.

If this script is insufficient for your use case, you run into problems running Zed, or there are errors uninstalling, please see our [Linux-specific documentation](./linux.md).
