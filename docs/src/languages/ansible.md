...
To change this behavior, you can add a `"file_types"` section to Zed settings inside your project (`.zed/settings.json`) or your Sawe user settings (`~/.spk/sawe/config/settings.json`) to match your folder/naming conventions. For example:
