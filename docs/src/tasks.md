...
- in the global `tasks.json` file; such tasks are available in all Zed projects you work on. This file is located at `~/.spk/sawe/config/tasks.json`. You can edit them by using the {#action zed::OpenTasks} action.
